    ...
    return (
      <div className="main">
        <MainContainer>
          ...
          />
          <div
            className="insta_content"
            dangerouslySetInnerHTML={{ __html: insta }}
          ></div>

          <div
            className="feed_insta"
            dangerouslySetInnerHTML={{ __html: feed_insta }}
          ></div>
